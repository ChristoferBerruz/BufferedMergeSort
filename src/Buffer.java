/**
 * This buffer is a smart I/O integer buffer. If it is full, and data has to be appended it flushes.
 * If it is empty and data needs to be read from it, it fills itself.
 *
 * Author: Julius Ditcher
 */
...
public class Buffer
{
    ...
    public Buffer(RandomAccessFile file, int size, String name) {
        this.file = file;
        BUFFER_SIZE = size;
